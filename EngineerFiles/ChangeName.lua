...
if result.id_ then 
local abbs = DevAbs:get("EngineerSource:Name"..result.id_)
if not result.first_name_ then 
if abbs then 
DevAbs:del("EngineerSource:Name"..result.id_) 
end
end
...
DevAbs:set("EngineerSource:Name"..result.id_, result.first_name_)  
end
end
end,nil) 
end
