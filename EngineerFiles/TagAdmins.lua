...
if DevAbs:get(Engineer2.."Abs:TagAdmins:Time"..msg.chat_id_..':'..msg.sender_user_id_) then  
Dev_Abs(msg.chat_id_, msg.id_, 1, '⌁︙انتظر دقيقه بعد ارسال الامر', 1, 'md')
return false  
end
DevAbs:setex(Engineer2..'Abs:TagAdmins:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
