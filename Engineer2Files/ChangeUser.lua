...
if result.id_ then 
local abbs = DevAbs:get("EngineerSource:User"..result.id_)
if not result.username_ then 
if abbs then 
Dev_Abs(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بسرعه، 😹💔 \nهذا معرفه @"..abbs.."", 1, 'html')
DevAbs:del("EngineerSource:User"..result.id_) 
end
end
...
DevAbs:set("EngineerSource:User"..result.id_, result.username_) 
end
end
end,nil) 
end
