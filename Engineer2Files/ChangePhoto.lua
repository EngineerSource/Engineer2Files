...
if result.id_ then 
local abbs = DevAbs:get("EngineerSource:Photo"..result.id_)
if not result.profile_photo_ then 
if abbs then 
Dev_Abs(msg.chat_id_, msg.id_, 1, "حذف كل صوره مضروب بوري، 😹💔", 1, 'html')
DevAbs:del("EngineerSource:Photo"..result.id_) 
end
end
...
DevAbs:set("EngineerSource:Photo"..result.id_, result.profile_photo_.big_.persistent_id_) 
end
end
end,nil) 
end
