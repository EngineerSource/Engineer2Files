...
if DevAbs:get(Engineer2.."Abs:Lock:MuteNames"..msg.chat_id_) then
if Manager(msg) then
...
DevAbs:sadd(Engineer2.."Abs:Mute:Names"..msg.chat_id_, MuteName)
end
...
DevAbs:srem(Engineer2.."Abs:Mute:Names"..msg.chat_id_, UnMuteName)
end
end
if text == "مسح الاسماء المكتومه" and Constructor(msg) then
DevAbs:del(Engineer2.."Abs:Mute:Names"..msg.chat_id_)
send(msg.chat_id_, msg.id_, "⌁︙تم مسح الاسماء المكتومه")
end
if text == "الاسماء المكتومه" and Constructor(msg) then
local AllNames = DevAbs:smembers(Engineer2.."Abs:Mute:Names"..msg.chat_id_)
...
if not Manager(msg) and DevAbs:get(Engineer2.."Abs:Lock:MuteNames"..msg.chat_id_) then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
if result.id_ then 
Engineer2Name = ((result.first_name_ or "") .. (result.last_name_ or ""))
if Engineer2Name then 
Engineer2Names = DevAbs:smembers(Engineer2.."Abs:Mute:Names"..msg.chat_id_) or ""
if Engineer2Names and Engineer2Names[1] then 
for i=1,#Engineer2Names do 
if Engineer2Name:match("(.*)("..Engineer2Names[i]..")(.*)") then 
...
DevAbs:set(Engineer2.."Abs:Lock:MuteNames"..msg.chat_id_,true)
end
...
DevAbs:del(Engineer2.."Abs:Lock:MuteNames"..msg.chat_id_)
end
end
end
